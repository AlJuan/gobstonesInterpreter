 ...
 * ModExpression
 * 
 * Responsabilidad: Expresion resto entre dos objetos numericos.
 * 
 * */
public class ModExpression extends TwoOperandExpression {
	...
	public Object evaluate(Board board, ProgramStack stack) {
		...
		return new GobstonesNumber(left.getValue()
				% right.getValue());
	}
