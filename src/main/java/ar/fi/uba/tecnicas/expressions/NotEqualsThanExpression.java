...
/**
 * NotEqualsThanExpression
 * 
 * Responsabilidad: Expresion de diferencia entre dos objetos comparables.
 * 
 * */
public class NotEqualsThanExpression extends TwoOperandExpression{

	public NotEqualsThanExpression(Expression leftExpression, Expression rightExpression) {
		super(leftExpression, rightExpression);
	}
	
	public NotEqualsThanExpression() {
		super();
	}
