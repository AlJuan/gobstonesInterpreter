...
/**
 * LesserOrEqualsThanExpression
 * 
 * Responsabilidad: Expresion menor o igual entre dos objetos comparables.
 * 
 * */
public class LesserOrEqualsThanExpression extends TwoOperandExpression {

	public LesserOrEqualsThanExpression(Expression leftExpression,
			Expression rightExpression) {
		super(leftExpression, rightExpression);
	}

	public LesserOrEqualsThanExpression() {
		super();
	}
